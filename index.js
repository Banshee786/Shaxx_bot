...
client.on('message', msg => {
  ...
  //ingores messages not in guilds(servers)
    ...
    if (command === 'resume') {
      ...
      try {
        ...
        console.error(error);
        msg.reply('That command doesnt work around here, guardian...');
      }
  ...
  //V1 Below WAS MOVED TO SEPARATE COMMANDS FILES
//   if (command === 'ping') {
...
//     msg.channel.send(`This week's crucible   const args = msg.content.slice(prefix.length).trim().split(/ +/g);
//
